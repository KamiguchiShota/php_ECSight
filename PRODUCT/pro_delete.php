...
<?php } ?>
  ...
  <input type="hidden" name="productcode" value="<?php print $pro_productcode; ?>"><br>
  <input type="hidden" name="gazou_name" value="<?php print $pro_gazou_name; ?>"><br>
    
  <div class="div_product_delete">
    <div class="product_delete">
    <h4>商品コード：<?php print $pro_productcode; ?></h4>
    <h4>商品名：<?php print $pro_productname; ?></h4>
    <?php print $disp_gazou; ?>
    <p>この商品を本当に削除していいですか？</p>
    </div>
  <div class="button">
  <input type="submit" value="削除" class="dalete_button">
